...
namespace Oct.Framework.Socket.Collections
{
    ...
    public class ImmutableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public int Count
        {
            get { return _headDictionary.Count; }
        }
        ...
        {
            get { return _headDictionary.Keys; }
        }
        ...
        {
            get { return _headDictionary.Values; }
        }
        ...
        {
            get { return _headDictionary[key]; }
            set { PromoteChanges(headDictionary => headDictionary.SetValue(key, value)); }
        }

        #endregion

        private void PromoteChanges(
            Func<BaseImmutableDictionary<TKey, TValue>, BaseImmutableDictionary<TKey, TValue>> candidateBuilder)
        {
