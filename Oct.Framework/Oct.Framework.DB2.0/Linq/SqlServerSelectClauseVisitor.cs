...
namespace Oct.Framework.DB.Linq
{
    internal class SqlServerSelectClauseVisitor : ThrowingExpressionTreeVisitor
    {
        ...
        private SqlServerSelectPartsCommandBuilder commandBuilder;
        ...
        /// 构造函数
        /// </summary>
        public SqlServerSelectClauseVisitor()
        {
        }
        ...
        {
            string itemName = expression.ReferencedQuerySource.ItemName.Contains("<generated>") ? "T" : expression.ReferencedQuerySource.ItemName.ToLower();
