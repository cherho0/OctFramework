...
using Oct.Tools.Host;
using System;

namespace OctCodeGen
{
    ...
    public class Connect : IDTExtensibility2, IDTCommandTarget
    {
        ...
        public void OnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
        {
            ...
            if (connectMode == ext_ConnectMode.ext_cm_UISetup)
            {
                ...
                try
                {
                    ...
                    Command command = commands.AddNamedCommand2(_addInInstance, "OctCodeGen", "OctCodeGen", "Executes the command for OctCodeGen", true, 59, ref contextGUIDS, (int)vsCommandStatus.vsCommandStatusSupported + (int)vsCommandStatus.vsCommandStatusEnabled, (int)vsCommandStyle.vsCommandStylePictAndText, vsCommandControlType.vsCommandControlTypeButton);
        ...
        public void QueryStatus(string commandName, vsCommandStatusTextWanted neededText, ref vsCommandStatus status, ref object commandText)
        {
            ...
            {
                if (commandName == "OctCodeGen.Connect.OctCodeGen")
                {
