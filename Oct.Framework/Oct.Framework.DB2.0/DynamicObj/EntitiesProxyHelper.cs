...
{
    public class EntitiesProxyHelper
    {
        ...
        public static ClassProxyInfo GetProxyInfo(Type t)
        {
            if (_proxyInfos.ContainsKey(t))
            {
                return _proxyInfos[t];
            }
            else
            {
                CreateProxy(t);
