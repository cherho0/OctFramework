...
(function() {
	...
	LetsKillIE6.prototype = {
		...
		_show: function(args) {
			...
			_self._setOpacity({
				_self: _self,
				element: dialog,
				opacity: _self.cache.opacity
			});
			dialog.style.top = height + 'px';
			dialog.style.visibility = 'visible';
			dialog.style.display = 'inline';

			_self.cache.showThread = setInterval(function() {
				_self._fadeIn({
					_self: _self
				});
			}, 40);
		...
		_hide: function(args) {
			var _self = args._self;
			var dialog = _self.cache.dialog;
			_self.cache.hideThread = setInterval(function() {
				_self._fadeOut({
					_self: _self
				});
			}, 40);
	...
	(new LetsKillIE6()).init({
		...
		cssUrl: '/assets/octopus/css/killie6.css',
		html: '<div class="bg"></div>' +
			'<div class="killie6"><div id="letskillie6-close" style="display:none;""></div>您正在使用 Internet Explorer 6 浏览网页，无法使用完整功能，建议您升级到更新的浏览器。<br><br>推荐使用 <a rel="nofollow" href="https://www.google.com/chrome/browser/" target="_blank">Google Chrome</a><a rel="nofollow" target="_blank" href="http://www.mozilla.org/zh-CN/firefox/new/">Firefox</a>。<br><br>更多浏览器下载：' +
			'<a rel="nofollow" target="_blank" href="http://www.microsoft.com/zh-cn/download/internet-explorer-8-details.aspx">IE 8</a>' +
			'<a rel="nofollow" target="_blank" href="http://www.microsoft.com/zh-cn/download/internet-explorer-9-details.aspx">IE 9(Windows XP无法使用)</a>' +
			'<a rel="nofollow" target="_blank" href="http://www.opera.com/zh-cn">Opera</a></div>'
	});
